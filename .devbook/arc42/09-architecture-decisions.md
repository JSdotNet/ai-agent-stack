...
[Only a Delivered Rule Lives in `rules/`](#only-a-delivered-rule-lives-in-rules): those seven
...
## Only a Delivered Rule Lives in `rules/`
...
kind, as [Budgets Are Disclosure Triggers, Not Gates](#budgets-are-disclosure-triggers-not-gates)
already allows.

## One Plugin, One Bounded Context

```meta
date: 2026-09-08
related: [".devbook/domain/context-map.md", ".devbook/domain/plugin-authoring/domain.md", ".devbook/arc42/09-architecture-decisions.md#one-folder-per-plugin", ".devbook/arc42/tdr/4-delivery-depends-on-devbook.md"]
```
...
```meta
date: 2026-09-08
related: [".devbook/arc42/05-building-block-view.md#roles-and-services", ".devbook/domain/delivery/skills.md", ".devbook/arc42/09-architecture-decisions.md#the-point-set-is-closed"]
```
...
a set [the surface contract calls closed](#the-point-set-is-closed).
...
```meta
date: 2026-09-09
related: [".devbook/domain/devbook/domain.md#chapter-type", ".devbook/arc42/09-architecture-decisions.md#a-context-describes-its-skills-and-keeps-its-terms-in-domainmd"]
```
