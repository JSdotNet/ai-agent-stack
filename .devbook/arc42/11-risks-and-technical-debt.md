...
| --- | --- | --- | --- | --- |
| [1. The body budgets are unenforced](tdr/1-body-budgets-unenforced.md) | 2026-09-04 | Low | in-progress | CLAUDE.md states three size budgets as bare thresholds; 13 of 82 budgeted assets meet them, and the disclosure rule that made them checkable was dropped in the port. |
