...
```meta
date: 2026-09-07
related: [".devbook/arc42/09-architecture-decisions.md", ".devbook/domain/plugin-authoring/domain.md", ".devbook/arc42/adr/25-devbook-payload-named-after-its-plugin.md", ".devbook/arc42/adr/58-the-design-artifacts-are-no-longer-cited.md", ".devbook/arc42/11-risks-and-technical-debt.md"]
```
...
[58](58-the-design-artifacts-are-no-longer-cited.md) retired that citation along with the other
