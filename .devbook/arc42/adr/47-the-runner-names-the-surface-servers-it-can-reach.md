...
```meta
date: 2026-09-09
related: [".devbook/arc42/09-architecture-decisions.md", ".devbook/arc42/adr/15-three-surfaces-one-contract.md", ".devbook/arc42/adr/16-a-surface-declares-only-the-contracts-tool-names.md", ".devbook/domain/plugin-authoring/domain.md#surface", ".devbook/arc42/adr/57-the-runner-opens-no-browser-pane.md"]
```
...
its argument stops is [record 57](57-the-runner-opens-no-browser-pane.md).
