...
```meta
date: 2026-09-09
related: [".devbook/arc42/09-architecture-decisions.md", ".devbook/domain/devbook/domain.md#chapter-type", ".devbook/arc42/adr/45-a-context-describes-its-skills-and-keeps-its-terms-in-domainmd.md"]
```
