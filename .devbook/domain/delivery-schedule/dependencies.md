...
| Plugin Authoring | Shared Kernel | Plugin folder, two manifests, marketplace entry, `resources/` contracts, the `components.schedule` stamp | [naming.md](../plugin-authoring/naming.md) | It is packaged, installed, and stamped like everything else here. |
