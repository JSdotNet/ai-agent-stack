...
```meta
type: dependencies
related: [".devbook/domain/context-map.md#delivery-surface-collector", ".devbook/arc42/09-architecture-decisions.md#three-surfaces-one-contract"]
```
...
- **The absent render group is a declaration, not a gap.** A caller finds it unanswered and
  ...
  which is the reason [the decision](../../arc42/09-architecture-decisions.md#a-surface-declares-only-the-contracts-tool-names)
