...
```meta
type: dependencies
related: [".devbook/domain/context-map.md#delivery-surface-dashboard", ".devbook/arc42/09-architecture-decisions.md#a-surface-declares-only-the-contracts-tool-names"]
```
...
| Plugin Authoring | Shared Kernel | Plugin folder, two manifests, marketplace entry, `mcp/<server>/`, `hooks/hooks.json` | [naming.md](../plugin-authoring/naming.md) | It is packaged like everything else here. |
