...
```meta
type: dependencies
related: [".devbook/domain/context-map.md#delivery", ".devbook/arc42/tdr/4-delivery-depends-on-devbook.md", ".devbook/arc42/09-architecture-decisions.md#delivery-ships-no-surface"]
```
