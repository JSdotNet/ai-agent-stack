...
```meta
type: flow
related: [".devbook/domain/delivery/domain.md#run", ".devbook/domain/delivery/domain.md#gate", ".devbook/arc42/09-architecture-decisions.md#every-run-opens-with-update-base"]
```
