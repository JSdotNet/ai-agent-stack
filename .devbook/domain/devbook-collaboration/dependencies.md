...
- **Promotion to a work item is not here, and the Separate Ways row above is why.** A note that
  ...
  [record 59](../../arc42/adr/59-the-annotation-lifecycle-ends-in-devbook.md).
