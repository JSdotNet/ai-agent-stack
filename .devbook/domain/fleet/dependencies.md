...
| Plugin Authoring | Shared Kernel | Plugin folder, two manifests, marketplace entry, `resources/` contract | [naming.md](../plugin-authoring/naming.md) | It is packaged like everything else here. |
