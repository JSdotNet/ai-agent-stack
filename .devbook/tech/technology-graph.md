...
related: [".devbook/arc42/09-architecture-decisions.md#fleet-names-the-cli-directly"]
```
...
[the decision](../arc42/09-architecture-decisions.md#fleet-names-the-cli-directly).
