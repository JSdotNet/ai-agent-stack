...
| Routines | `routines` | A catalog of scheduled triggers over the two above: six routine files a repository selects from and syncs into its own scheduler, each naming a target skill, a cadence, and what it lands as. |
