---
name: schedule-run
description: 'Fire one of this repository''s schedules now, outside its cadence, and report the run. Use when: running a routine or automation now, testing one right after schedule-install, or re-running one that failed.'
---
