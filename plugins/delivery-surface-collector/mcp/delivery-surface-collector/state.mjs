...
export function stateDir() {
    if (process.env.DELIVERY_SURFACE_COLLECTOR_STATE_DIR) {
        return path.resolve(process.env.DELIVERY_SURFACE_COLLECTOR_STATE_DIR);
    }
    ...
    return path.join(home, "delivery-surface-collector", `${slug}-${hash}`);
}
