...
model: opus
tools: ['Read', 'Grep', 'Glob', 'Write', 'Edit', 'Bash', 'Agent', 'SendMessage', 'Skill', 'AskUserQuestion', 'read/readFile', 'search/codebase', 'search', 'search/findTestFiles', 'edit/createFile', 'edit/editFiles', 'agent', 'terminal/runInTerminal', 'list_canvas_capabilities', 'open_canvas', 'invoke_canvas_action', 'list_projects', 'create_session', 'send_session_message', 'list_sessions_and_chats', 'get_session', 'respond_to_session_plan', 'mcp__plugin_delivery-dashboard_delivery-dashboard', 'mcp__delivery-dashboard', 'mcp__plugin_delivery-collector_delivery-collector', 'mcp__delivery-collector', 'mcp__plugin_delivery-canvas_delivery-canvas', 'mcp__delivery-canvas', 'mcp__plugin_claude-desktop_orch-dashboard', 'mcp__orch-dashboard', 'mcp__Claude_Browser__preview_start', 'mcp__Claude_Browser__tabs_context', 'mcp__Claude_Browser__navigate']
---
