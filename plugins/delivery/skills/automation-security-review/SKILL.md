...
- Never modify source, never push, never merge. Fixing is a flow's job; this automation opens
...
- `start_run` with `skillId: "automation-security-review"` and these stages: Dependencies,
...
- A finding this automation opened is worked through `flow-bug` or `flow-update-packages`
